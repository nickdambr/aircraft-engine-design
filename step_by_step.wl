...
(* ::Input:: *)
(*TWTO=(\[Beta]^2/\[Alpha] kTO^2/(sG \[Rho] g0 CLmax) WLG)*)
...
(*ruleTO={*)
(*\[Beta]->\[Beta]TO,*)
(*\[Alpha]->\[Alpha]LTFmax[hfield,0,TR],*)
(*kTO->1.2,*)
(*sG->sTO-tr*VTO,*)
(*sTO->700,*)
(*tr->3,*)
(*VTO->kTO*Vstall,*)
(*Vstall->Sqrt[(2*WLG)/(\[Rho]*CLmax)],*)
(*\[Rho]->\[Rho]std[hfield,Tto],*)
(*Tto->29.8+273.15,*)
(*CLmax->2*)
(*};*)
...
(* ::Input:: *)
(*plotTO=Plot[TWTO//.ruleTO,{WLG,0,8000},Filling->Bottom,PlotRange->{{2000,6000},All},Frame->True,FrameLabel->{"\!\(\*FractionBox[\(W\), \(S\)]\) [N/\!\(\*SuperscriptBox[\(m\), \(2\)]\)]","\!\(\*FractionBox[\(T\), \(W\)]\)"},PlotStyle->{Blue},FrameStyle->Directive[Black,FontSize->16,FontFamily->"Arial"]]*)
(*Plot[TWTO//.ruleTO,{WLG,0,8000}]*)
...
(*hTurn=10000;*)
(*p0Turn=pstd[hTurn];*)
(*\[Beta]Turn=0.85; (*valore stimato dal mattingly*)*)
(*nTurn=5;*)
(*M0Turn=1.6;*)
(**)
(*ruleturn1={*)
...
(*h->hTurn,*)
(*\[Beta]->\[Beta]Turn,*)
(*\[Alpha]->\[Alpha]LTFmax[hTurn,M0Turn,TR],*)
(*CDR->0,*)
(*K1->k1[commercial,fighter,M0Turn,AR,e],*)
(*K2->k2[commercial,fighter],*)
(*CD0->cd0[commercial,fighter,M0Turn],*)
(*M0->M0Turn,*)
(*\[Gamma]->1.4*)
(*};*)
...
(* ::Input:: *)
(*plotTURN1=Plot[RHS//.ruleturn1,{WLG,2000,8000},Filling->Bottom,PlotRange->{{3500,5500},All},Frame->True,FrameLabel->{"\!\(\*FractionBox[\(W\), \(S\)]\) [N/\!\(\*SuperscriptBox[\(m\), \(2\)]\)]","\!\(\*FractionBox[\(T\), \(W\)]\)"},PlotStyle->{Blue},FrameStyle->Directive[Black,FontSize->16,FontFamily->"Arial"]]*)
(*Plot[RHS//.turn1,{WLG,2000,8000}]*)
...
(* ::Input:: *)
(*TWturn2=RHS//.turn2;*)
(*plotTURN2=Plot[RHS//.ruleturn2,{WLG,2000,8000},Filling->Bottom,PlotRange->{{3500,5500},All},Frame->True,FrameLabel->{"\!\(\*FractionBox[\(W\), \(S\)]\) [N/\!\(\*SuperscriptBox[\(m\), \(2\)]\)]","\!\(\*FractionBox[\(T\), \(W\)]\)"},PlotStyle->{Blue},FrameStyle->Directive[Black,FontSize->16,FontFamily->"Arial"]]*)
(*Plot[RHS//.turn2,{WLG,2000,8000}]*)
